"""cabin_lowpoly.blend -> client/assets/game_assets/buildings/village/LogCabin.glb (Bevy 0.19).

    blender asset_creation/houses/cabin_lowpoly.blend --background --python asset_creation/houses/export_cabin_glb.py
