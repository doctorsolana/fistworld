"""Author `door_open` and `door_close` on the cabin door.
    ...
    blender asset_creation/houses/cabin_lowpoly.blend --background --python asset_creation/houses/animate_cabin_door.py
...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "cabin_lowpoly.blend")
