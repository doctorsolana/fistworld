"""Low-poly log cabin — the SHIPPED cabin (its mesh is `CabinLowPoly` in LogCabin.glb).
    ...
    blender --background --factory-startup --python asset_creation/houses/build_log_cabin.py
...
OUT_BLEND = os.path.join(os.path.dirname(os.path.abspath(__file__)), "log_cabin.blend")
