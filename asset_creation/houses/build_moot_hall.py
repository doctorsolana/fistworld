"""Town hall — two storeys, in the same log-cabin family, and deliberately NOT grand.
    ...
    # or, in the live session:  exec(open(".../build_moot_hall.py").read())
...
OUT_BLEND = os.path.join(os.path.dirname(os.path.abspath(__file__)), "moot_hall.blend")
...
obj, me = finish(bm, "MootHall")
glass_obj, glass_me = finish(glass_bm, "MootHallGlass")
door_obj, door_me = finish(door_bm, "MootHallDoor",
