"""Ignored fishermans_hut inspection with a metre-scale character and looping door cycle.
Run with fishermans_hut.blend loaded. Canonical/runtime assets are not changed.
"""
...
scene.name = "FishermansHut inspection"
leaf = bpy.data.objects["FishermansHutDoor"]
...
for obj in added:
    if obj.parent is None:
        obj.location += Vector((1.35, 3.60, 0))
...
for screen in bpy.data.screens:
    for area in screen.areas:
        ...
        view.region_3d.view_distance = 10.5
        view.region_3d.view_perspective = "PERSP"
bpy.ops.object.select_all(action="DESELECT")
bpy.context.view_layer.objects.active = bpy.data.objects["FishermansHut"]
scene["Inspection"] = (
    "Space plays the authored open/close clips. Orbit below the canopy and eaves; floor top is grade. Character is 1.70 m."
)
bpy.ops.wm.save_as_mainfile(
    filepath=str(ROOT / "asset_creation/houses/renders/fishermans_hut-review.blend")
)
