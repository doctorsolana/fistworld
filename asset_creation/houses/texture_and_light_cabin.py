"""Texture the low-poly cabin with a baked voxel grain, and build a lit studio scene.
    ...
    blender asset_creation/houses/cabin_lowpoly.blend --background --python asset_creation/houses/texture_and_light_cabin.py
...
OUT_BLEND = os.path.join(HERE, "cabin_lowpoly.blend")
