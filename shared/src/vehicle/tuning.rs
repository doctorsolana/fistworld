...
pub fn vehicle_def(vehicle_type: VehicleType) -> VehicleDef {
    match vehicle_type {
        ...
        VehicleType::Car => VehicleDef {
            ...
            rolling_resistance: 240.0,
            engine_brake_driver: 1100.0,
            engine_brake_no_driver: 480.0,
            steering_speed_min: 1.05,
            steering_speed_max: 0.42,
            steering_response: 10.0,
            turn_lean_angle: 0.0,
            lean_speed: 4.0,
            mu_desert: 1.35,
            mu_grasslands: 1.55,
            lateral_friction: 30.0,
            landing_drift_preserve: 0.18,
