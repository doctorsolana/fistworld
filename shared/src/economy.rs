...
pub use settlement::{
    ...
    CITY_REQUIRED_DAYS, DEVELOPMENT_REQUIRED_DAYS, DEVELOPMENT_WINDOW_DAYS,
    FOOD_SECURITY_TARGET_DAYS, TOWN_HALL_STONE_REQUIRED, TOWN_MIN_HOUSED_RESIDENTS,
    TOWN_MIN_OPERATING_BUSINESS_TYPES, TOWN_MIN_RESIDENTS, VILLAGE_HALL_WOOD_REQUIRED,
    VILLAGE_MIN_HOUSED_RESIDENTS, VILLAGE_MIN_OCCUPIED_HOMES, VILLAGE_MIN_RESIDENTS,
};
pub use tavern::{
