...
fn spawn_place_card(card: &mut ChildSpawnerCommands<'_>) {
    ...
    .with_children(|header| {
        header
            ...
            .with_children(|copy| {
                copy.spawn((PlaceDetailName, ledger::heading("", 38.0)));
                copy.spawn((PlaceDetailSubtitle, ledger::body("", 20.0)));
                copy.spawn((
                    PlaceActionsRow,
                    Node {
    ...
    .with_children(|tiles| {
        for index in 0..super::PLACE_DETAIL_TILES {
            tiles
                ...
                .with_children(|tile| {
                    tile.spawn((PlaceDetailTileLabel(index), ledger::body("", 17.0)));
                    tile.spawn((PlaceDetailTileValue(index), ledger::heading("", 23.0)));
                });
        }
    });
    card.spawn((
...
fn action(
    ...
    parent
        ...
        .with_child((UiButtonLabel, ledger::heading(label, 12.0)));
}
